...
func (c *ServiceTplController) Create() {
	...
	_, err = models.ServiceTplModel.Add(&serviceTpl)
	if err != nil {
...
func (c *ServiceTplController) Get() {
	...
	serviceTpl, err := models.ServiceTplModel.GetById(id)
	if err != nil {
...
func (c *ServiceTplController) Update() {
	...
	err = models.ServiceTplModel.UpdateById(&serviceTpl)
	if err != nil {
...
func (c *ServiceTplController) Delete() {
	...
	err := models.ServiceTplModel.DeleteById(int64(id), logical)
	if err != nil {
