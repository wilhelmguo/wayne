...
func (c *ServiceController) GetNames() {
	...
	services, err := models.ServiceModel.GetNames(filters)
	if err != nil {
...
func (c *ServiceController) Create() {
	...
	_, err = models.ServiceModel.Add(&service)
...
func (c *ServiceController) Get() {
	...
	service, err := models.ServiceModel.GetById(int64(id))
	if err != nil {
...
func (c *ServiceController) Update() {
	...
	service.Id = int64(id)
	err = models.ServiceModel.UpdateById(&service)
	if err != nil {
...
func (c *ServiceController) UpdateOrders() {
	...
	err = models.ServiceModel.UpdateOrders(services)
	if err != nil {
...
func (c *ServiceController) Delete() {
	...
	err := models.ServiceModel.DeleteById(int64(id), logical)
	if err != nil {
